...
export default function About({}: Props) {
  return (
    <header className="p-5 flex items-start justify-between ">
      ...
      >
        <h3 className="absolute top-24 uppercase tracking-[15px] md:tracking-[15px] lg:tracking-[15px] xl:tracking-[15px] text-gray-500 text-xl md:text-2xl lg:text-2xl xl:text-2xl">
          About Me
        </h3>
        <motion.img
          initial={{ x: -200, opacity: 0 }}
          ...
          whileInView={{ opacity: 1, x: 0 }}
          src="/about.jpeg"
          className=" mt-20 -mb-10 md:mt-0 lg:mt-0 md:mb-0 flex-shrink-0 w-36 h-36 rounded-full object-cover md:rounded-lg md:w-64 md:h-64 lg:w-64 lg:h-64 xl:w-[400px] xl:h-[400px]"
        />
        <motion.div
          initial={{ x: 200, opacity: 0 }}
          transition={{ duration: 0.8 }}
        ...
        >
          <p className="text-sm md:text-sm lg:text-sm font-sans xl:leading-loose lg:leading-loose md:leading-loose ">
